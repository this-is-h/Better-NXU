        ...
        unsafeWindow.betterNXUVersionClick = () => {
            GM_xmlhttpRequest({
                ...
                onload: (res) => {
                    ...
                    !json.hitokoto ? createToast("info", `之前点的太快啦<br>休息一下吧`, 3) : createToast("info", `<a href="https://hitokoto.cn/" target="_blank" style="text-decoration: none;color: inherit;">${json.hitokoto}<br>——${json.from}</a>`, 3)
                }
            });
        }
        GM_addStyle(`
